...
//if jobseeker wants to upload CV
...
//end of jobseeker wants to upload CV
?>
...
<head>
<title>JMG_Jobseekers_GAR</title>
...
<h3>Welcome to <?php echo $region; ?> Region</h3>
...
while($a==0 && $k < mysql_num_rows($result)){
	...
	<input type="hidden" name="ID" value="GA00_'.$result_ID.'" />
...
while($i< mysql_num_rows($result)){
 $region_query2 = mysql_query($query, $connection) or die(mysql_error());
 $region_result2 = mysql_result($region_query2, $i, "region");
...
<input type="submit" name="submit" value="Submit Cover Letter and CV" />
 ...
 echo '<h3><i>No Job Vacancies for the '.$region.' Region are up yet</i></h3>';
 }
