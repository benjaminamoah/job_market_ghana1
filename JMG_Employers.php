...
<br />
<h4>Welcome to Employers' Section of JMG</h4>

<br />
<div id="enc_register_login_form">
<div id="register">
Begin the simple process of anouncing your job vacancy with JMG.

<br />
<b><i><a href="JMG_Employers_registration.php">Create Account</a></i></b>
</div>

<div id="login_form">
<!--login form begins-->
<fieldset><legend>Already Have An Account? Sign In Here!</legend>
...
<td>
<input type="text" style="font-size:15px" name="username" value="<?php echo $username ?>" ><br /><br />
</td></tr>
<tr><td>
Password:&#160;
</td><td>
<input type="password" style="font-size:15px" name="password" />
</td></tr>
<tr>
