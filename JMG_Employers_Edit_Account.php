...
if(isset($_POST['Submit_btn_x'])){
 ...
 if($u == 1){
 $username_error = "You should fill in a username.";
 }else{$username_error = "";}
 ...
 if($n == 1){
 $company_name_error = "Please state your company/organization name";
 ...
 if($r == 1){
 $region_error = "Please select the region in which your company/organization is located";
 }else{$region_error = "";}
 ...
 if($t == 1){
 $tel_number_error = "Please include a contact number through which applicants may enquire about the progress of their job applications";
 ...
 if($p == 1){
 $position_error = "Please state the job title";
 }else{$position_error = "";}
 ...
 if($q == 1){
 $qualification_error = "Please specify the qualifications required of applicants";
 ...
 if($w == 1){
 $work_experience_error = "Please specify the job experience required";
 ...
 if($d == 1){
 $deadline_error = "Please specify an application deadline";
 }else{$deadline_error = "";}
...
if($i==1){
	$date = time();
	$update_record = "update employers set user='$username1', pass='$password', company='$company_name', region='$region', telephone_number='$tel_number', position='$position', qualification='$qualification', work_experience='$work_experience', dd='$deadline_day', dm='$deadline_month', dy='$deadline_year', other_info='$other_info' where user='$username'";
	mysql_query($update_record, $connection) or die(mysql_error());
...
<h3><font decorate="underline">You may make the chages you want and then click on "Save Changes" when done.</font></h3>
<span class="error">*</span>&#160;<b>Required Fields</b><br /><br />

<fieldset><legend><b>Update Account Details</b></legend>
...
<input type="text" name="username" value="<?php echo $result_username; ?>" ></td><td><?php print '<span class="error">'.$username_error."</span>"; ?><br /><br />
</td></tr>
<tr><td>
...
<td>
<input type="text" name="company_name" value="<?php echo $result_company ?>" ></td><td><?php print '<span class="error">'.$company_name_error."</span>"; ?><br />
</td></tr>
<tr><td>
...
<td>
			...
			<select type="text" name="region">
				<option bgcolor="$cccccc"><?php echo $result_region; ?></option>
				<option>--</option>
...
<td>
<input type="text" name="tel_number" value="<?php echo $result_tel_number ?>" ></td><td><?php print '<span class="error">'.$tel_number_error."</span>"; ?><br />
</td></tr>
<tr><td>
<span class="error">*</span>Position Available:&#160;
</td>
<td>
<input type="text" name="position" value="<?php echo $result_position ?>" ></td><td><?php echo '<span class="error">'.$position_error."</span>"; ?><br />
</td></tr>
<tr><td>
<span class="error">*</span>Qualification:&#160;
</td>
<td>
<input type="text" name="qualification" value="<?php echo $result_qualification ?>" ></td><td><?php print '<span class="error">'.$qualification_error."</span>"; ?><br />
</td></tr>
<tr><td>
<span class="error">*</span>Work Experience:&#160;
</td>
<td>
<input type="text" name="work_experience" value="<?php echo $result_work_experience ?>" ></td><td><?php print '<span class="error">'.$work_experience_error."</span>"; ?><br />
</td></tr>
			...
			<td><select type="text" name="deadline_day">
				<option bgcolor="#cccccc"><?php echo $result_dd; ?></option>
				<option>--</option>
				<option>01</option>
				<option>02</option>
				<option>03</option>
			...
			<select type="text" name="deadline_month">
				<option bgcolor="#cccccc"><?php echo $result_dm; ?></option>
				<option>--</option>
			...
			<select type="text" name="deadline_year">
				<option bgcolor="#cccccc"><?php echo $result_dy; ?></option>
				<option>2010</option>
				<option>2011</option>
				<option>2012</option>
				<option>2013</option>
...
<td>
<textarea style="width: 150%" rows="10" name="other_info" value="<?php echo $result_other_info; ?>" ></textarea><br />
</td></tr>
<tr><td>
&#160;
</td></tr>
...
<input type="image" src="JMGimg/save_changes.png" name="Submit_btn" />
</td></tr>
</table>
</form>
</fieldset>
